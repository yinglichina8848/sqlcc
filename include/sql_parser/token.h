...
public:
    ...
    enum Type {
        ...
        KEYWORD_BETWEEN, KEYWORD_LIMIT, KEYWORD_OFFSET,
        KEYWORD_ASC, KEYWORD_DESC, KEYWORD_PRIMARY,
        KEYWORD_KEY, KEYWORD_UNIQUE, KEYWORD_NOT_NULL,
        KEYWORD_NULLABLE, KEYWORD_DEFAULT, KEYWORD_CONSTRAINT,
