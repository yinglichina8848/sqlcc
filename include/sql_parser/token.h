...
public:
    ...
    enum Type {
        ...
        KEYWORD_AS, KEYWORD_DISTINCT, KEYWORD_AND,
        KEYWORD_OR, KEYWORD_NOT, KEYWORD_NULL,
        KEYWORD_IS, KEYWORD_LIKE, KEYWORD_IN,
        KEYWORD_EXISTS, KEYWORD_BETWEEN, KEYWORD_LIMIT, KEYWORD_OFFSET,
        KEYWORD_ASC, KEYWORD_DESC, KEYWORD_INDEX, KEYWORD_PRIMARY,
        KEYWORD_KEY, KEYWORD_UNIQUE, KEYWORD_IF,
        KEYWORD_NOT_NULL, KEYWORD_NULLABLE, KEYWORD_DEFAULT, KEYWORD_CONSTRAINT,
        KEYWORD_FOREIGN, KEYWORD_REFERENCES,
        KEYWORD_CHECK,
        KEYWORD_DECIMAL, KEYWORD_DATE, KEYWORD_TIME,
        KEYWORD_TIMESTAMP, KEYWORD_CHAR, KEYWORD_VARCHAR,
        KEYWORD_SMALLINT, KEYWORD_DOUBLE, KEYWORD_BOOLEAN,
        ...
        PUNCTUATION_DOT, PUNCTUATION_COLON,
