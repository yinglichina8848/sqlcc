...
TEST(NetworkTaskTest, BasicFunctionality) {
    ...
    EXPECT_TRUE(result->isSuccess());
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("Processed network request: GET /test"));
}
...
TEST(SQLTaskTest, BasicFunctionality) {
    ...
    EXPECT_TRUE(result->isSuccess());
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("Executed SQL: SELECT * FROM test"));
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("in transaction 12345"));
}
...
TEST(WALTaskTest, BasicFunctionality) {
    ...
    EXPECT_TRUE(result->isSuccess());
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("Written to WAL log: log_entry"));
}
...
TEST(TransactionTaskTest, BeginOperation) {
    ...
    EXPECT_TRUE(result->isSuccess());
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("Transaction 54321 started"));
}
...
TEST(TransactionTaskTest, CommitOperation) {
    ...
    EXPECT_TRUE(result->isSuccess());
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("Transaction 54321 committed"));
}
...
TEST(TransactionTaskTest, RollbackOperation) {
    ...
    EXPECT_TRUE(result->isSuccess());
    EXPECT_THAT(result->getResultData(), ::testing::HasSubstr("Transaction 54321 rolled back"));
}
