...
|-------|---------|---------|---------|------------|----------|
| v1.3.9 | 2026-01-30 | Level 1 Foundation完整测试 | Level 1 Foundation完整单元测试完成，约160个测试用例，100%通过率 | [查看](RELEASE_NOTES_v1.3.9.md) | [查看](CHANGELOG_v1.3.9.md) |
| v1.3.8 | 2026-01-22 | SQL Parser模块化重构 | SQL Parser模块拆分为5个功能子库，实现模块化架构和增量编译 | [查看](RELEASE_NOTES_v1.3.8.md) | [查看](CHANGELOG_v1.3.8.md) |
| v1.3.7 | 2026-01-20 | Bazel构建系统重构 | 完成Bazel构建系统重构，优化构建依赖和编译效率 | [查看](RELEASE_NOTES_v1.3.7.md) | [查看](CHANGELOG_v1.3.7.md) |
| v1.3.6 | 2026-01-19 | LLVM覆盖率工具链完善 | 完善LLVM覆盖率测试工具链，实现完整的代码覆盖率分析系统 | [查看](RELEASE_NOTES_v1.3.6.md) | [查看](CHANGELOG_v1.3.6.md) |
| v1.3.5 | 2026-01-17 | 版本更新和文档完善 | 版本管理更新，文档同步，发布准备完成 | [查看](RELEASE_NOTES_v1.3.5.md) | [查看](CHANGELOG_v1.3.5.md) |
| v1.3.4 | 2026-01-14 | SQL-92特性深度集成 | SQL执行器深度集成SQL-92特性，实现集合操作、子查询、窗口函数等真实执行 | [查看](RELEASE_NOTES_v1.3.4.md) | [查看](CHANGELOG_v1.3.4.md) |
| v1.3.3 | 2026-01-13 | DDL/DCL功能补全 | DDL性能测试补全和DCL高级功能验证完成，功能补全度达到100% | [查看](RELEASE_NOTES_v1.3.3.md) | [查看](CHANGELOG_v1.3.3.md) |
| v1.3.2 | 2026-01-12 | DDL语句真实执行验证 | DDL语句真实执行验证完成，8个测试用例全部通过，SQL-92标准完全支持 | [查看](RELEASE_NOTES_v1.3.2.md) | [查看](CHANGELOG_v1.3.2.md) |
| v1.3.1 | 2026-01-12 | 测试改进 | SQLCC核心代码覆盖率测试系统完善，56.1%行覆盖率，59.6%函数覆盖率 | [查看](RELEASE_NOTES_v1.3.1.md) | [查看](CHANGELOG_v1.3.1.md) |
| v1.3.0 | 2026-01-11 | 功能发布 | SQLCC核心功能实现，Bazel构建系统集成，基本单元测试框架建立 | [查看](RELEASE_NOTES_v1.3.0.md) | [查看](CHANGELOG_v1.3.0.md) |
| v1.2.15 | 2026-01-09 | Client_Server架构 | SQLCC Client_Server架构项目规划和注释补全项目Phase9-14完成 | [查看](RELEASE_NOTES_v1.2.15.md) | [查看](CHANGELOG_v1.2.15.md) |
| v1.2.14 | 2026-01-08 | 测试覆盖率项目 | SQLCC测试覆盖率测试项目完成，编译环境基础修复 | [查看](RELEASE_NOTES_v1.2.14.md) | [查看](CHANGELOG_v1.2.14.md) |
| v1.2.13 | 2026-01-07 | 项目总结 | SQLCC测试系统项目最终总结报告，阶段3完成 | [查看](RELEASE_NOTES_v1.2.13.md) | [查看](CHANGELOG_v1.2.13.md) |
| v1.2.12 | 2026-01-06 | 错误修正 | SQLCC测试系统错误修正报告，层次4-7测试重构改进完成 | [查看](RELEASE_NOTES_v1.2.12.md) | [查看](CHANGELOG_v1.2.12.md) |
| v1.2.11 | 2026-01-05 | 层次4测试重构 | SQLCC测试系统完整索引报告，层次4测试重构改进完成报告 | [查看](RELEASE_NOTES_v1.2.11.md) | [查看](CHANGELOG_v1.2.11.md) |
| v1.2.10 | 2026-01-04 | 覆盖率测试系统 | SQLCC全面覆盖率测试系统完成报告，层次1-7测试分析报告 | [查看](RELEASE_NOTES_v1.2.10.md) | [查看](CHANGELOG_v1.2.10.md) |
| v1.2.9 | 2026-01-03 | 覆盖率改进 | SQLCC测试覆盖率改进项目完成报告，覆盖率测试执行报告 | [查看](RELEASE_NOTES_v1.2.9.md) | [查看](CHANGELOG_v1.2.9.md) |
| v1.2.8 | 2026-01-02 | 编译改进 | SQLCC编译和测试改进项目最终完成报告，系统性C++20迁移 | [查看](RELEASE_NOTES_v1.2.8.md) | [查看](CHANGELOG_v1.2.8.md) |
| v1.2.7 | 2025-12-30 | 测试目录分析 | v1.2.7测试目录全面分析报告，测试文件编译运行状态分析 | [查看](RELEASE_NOTES_v1.2.7.md) | [查看](CHANGELOG_v1.2.7.md) |
| v1.2.6 | 2025-12-29 | 注释补全 | v1.2.6注释补全项目完整TODO清单，Bazel构建系统重构 | [查看](RELEASE_NOTES_v1.2.6.md) | [查看](CHANGELOG_v1.2.6.md) |
| v1.2.5 | 2025-12-28 | 依赖分析 | 依赖分析报告，头文件重构改进报告，SQLCC重构改进总结 | [查看](RELEASE_NOTES_v1.2.5.md) | [查看](CHANGELOG_v1.2.5.md) |
| v1.2.4 | 2025-12-27 | Bazel重构 | Bazel构建配置系统性修复完成报告，测试重构改进总结报告 | [查看](RELEASE_NOTES_v1.2.4.md) | [查看](CHANGELOG_v1.2.4.md) |
| v1.2.3 | 2025-12-26 | 高级SQL-92 | 高级SQL-92特性开发完成报告，内存安全修复总结，测试改进综合分析 | [查看](RELEASE_NOTES_v1.2.3.md) | [查看](CHANGELOG_v1.2.3.md) |
| v1.2.2 | 2025-12-25 | 内存安全修复 | 深度修复完成报告，包括并发访问控制、异常处理、磁盘I/O等 | [查看](RELEASE_NOTES_v1.2.2.md) | [查看](CHANGELOG_v1.2.2.md) |
| v1.2.1 | 2025-12-24 | 评估报告 | v1.2.2评估报告，工作日记，测试改进计划 | [查看](RELEASE_NOTES_v1.2.1.md) | [查看](CHANGELOG_v1.2.1.md) |
| v1.2.0 | 2025-12-23 | 功能矩阵 | FUNCTION_MATRIX_v1.2.0，SQL-92差距分析，工作日记 | [查看](RELEASE_NOTES_v1.2.0.md) | [查看](CHANGELOG_v1.2.0.md) |
| v1.1.5 | 2025-12-20 | 存储过程触发器 | v1.1.5存储过程和触发器重构报告，代码质量评估，SQL-92支持度评估 | [查看](RELEASE_NOTES_v1.1.5.md) | [查看](CHANGELOG_v1.1.5.md) |
| v1.1.4 | 2025-12-18 | 内存安全深度修复 | 内存安全深度修复最终完成报告，B+树索引系统深度修复，测试修复与全面评估 | [查看](RELEASE_NOTES_v1.1.4.md) | [查看](CHANGELOG_v1.1.4.md) |
| v1.1.3 | 2025-12-16 | 内存安全革命 | 内存安全审计报告，性能基准报告，内存重构计划 | [查看](RELEASE_NOTES_v1.1.3.md) | [查看](CHANGELOG_v1.1.3.md) |
| v1.1.2 | 2025-12-14 | 全面测试分析 | v1.1.2全面测试分析报告，覆盖率测试报告，项目整理总结报告 | [查看](RELEASE_NOTES_v1.1.2.md) | [查看](CHANGELOG_v1.1.2.md) |
| v1.1.1 | 2025-12-06 | 权限管理完善与优化 | 实现列级权限控制，完善角色权限管理，优化权限验证性能，增强权限审计功能 | [查看](RELEASE_NOTES_v1.1.1.md) | [查看](CHANGELOG_v1.1.1.md) |
| v1.1.0 | 2025-12-05 | 查询优化器实现 | 实现基于代价的查询优化器，支持统计信息收集、多表JOIN优化和索引选择优化 | [查看](RELEASE_NOTES_v1.1.0.md) | [查看](CHANGELOG_v1.1.0.md) |
