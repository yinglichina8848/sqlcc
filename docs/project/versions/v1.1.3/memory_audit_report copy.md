...
| `/home/liying/sqlcc/include/storage/b_plus_tree.h` | 1 | 裸指针(1)  |
| `/home/liying/sqlcc/include/storage/b_plus_tree_nodes.h` | 4 | 裸指针(4)  |
...
| `/home/liying/sqlcc/include/utils/file_descriptor.h` | 12 | 裸指针(3) 文件描述符(9)  |
...
| `/home/liying/sqlcc/src/network/network.cpp` | 28 | 裸指针(22) 文件描述符(6)  |
...
| `/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp` | 18 | 裸指针(15) new/delete(3)  |
| `/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp` | 25 | 裸指针(12) new/delete(13)  |
...
| `/home/liying/sqlcc/src/storage_engine/table_storage.cpp` | 25 | 裸指针(24) new/delete(1)  |
| `/home/liying/sqlcc/src/unified_executor.cpp` | 6 | 裸指针(5) new/delete(1)  |
...
| `/home/liying/sqlcc/tests/components/storage/buffer_pool_test.cpp` | 10 | 裸指针(10)  |
...
| `/home/liying/sqlcc/tests/test_revoke_persistence.cpp` | 4 | 裸指针(4)  |
...
| `/home/liying/sqlcc/tests/unsupported_commands_test.cpp` | 1 | 裸指针(1)  |
...
```
/home/liying/sqlcc/include/page.h:165: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     void ReadDataToSpan(size_t offset, char* output_data, size_t size) const;
```
...
#### 📁 /home/liying/sqlcc/include/storage/b_plus_tree.h
...
```
/home/liying/sqlcc/include/storage/b_plus_tree.h:112: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     StorageEngine* storage_engine_;  ///< 存储引擎指针
```

#### 📁 /home/liying/sqlcc/include/storage/b_plus_tree_nodes.h
...
```
/home/liying/sqlcc/include/storage/b_plus_tree_nodes.h:20: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     BPlusTreeNode(StorageEngine* storage_engine, int32_t page_id, bool is_leaf);
```

**问题 2**:

```
/home/liying/sqlcc/include/storage/b_plus_tree_nodes.h:34: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     StorageEngine* storage_engine_;
```

**问题 3**:

```
/home/liying/sqlcc/include/storage/b_plus_tree_nodes.h:44: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     BPlusTreeInternalNode(StorageEngine* storage_engine, int32_t page_id);
```

**问题 4**:

```
/home/liying/sqlcc/include/storage/b_plus_tree_nodes.h:92: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     BPlusTreeLeafNode(StorageEngine* storage_engine, int32_t page_id);
```
...
```
/home/liying/sqlcc/include/utils/file_descriptor.h:166: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     static FileDescriptor accept(int sockfd, struct sockaddr* addr,
```
...
```
/home/liying/sqlcc/include/utils/file_descriptor.h:167: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:                                 socklen_t* addrlen, int flags = 0) {
```
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:66: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码: BPlusTreeNode::BPlusTreeNode(StorageEngine* storage_engine, int32_t page_id,
```

**问题 4**:

```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:123: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:144: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码: BPlusTreeInternalNode::BPlusTreeInternalNode(StorageEngine* storage_engine,
```

**问题 6**:

```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:187: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:238: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page_->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:415: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:417: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:461: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:461: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
  代码:  * BPlusTreeLeafNode *leaf_node = new BPlusTreeLeafNode(storage_engine,
```
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:482: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码: BPlusTreeLeafNode::BPlusTreeLeafNode(StorageEngine* storage_engine,
```

**问题 13**:

```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:524: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page_->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:575: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page_->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:889: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:889: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
  代码:  * BPlusTreeIndex *index = new BPlusTreeIndex(storage_engine, table_name,
```
...
```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:911: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码: BPlusTreeIndex::BPlusTreeIndex(StorageEngine* storage_engine,
```

**问题 18**:

```
/home/liying/sqlcc/src/storage_engine/b_plus_tree.cpp:1552: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = temp_page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:251: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
  代码:     SQLCC_LOG_WARN("Failed to acquire buffer pool lock for new page creation");
```

**问题 3**:

```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:269: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:384: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:385: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   void *page_data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:476: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     Page *page = page_it->second.get();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:477: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     void *page_data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:512: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   Page *page = page_it->second.get();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:541: 直接使用delete操作符 - 建议使用RAII模式自动管理内存
  代码:   delete page;
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:696: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:       Page *page = page_it->second.get();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:697: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:       void *page_data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:730: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:865: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:881: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:894: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:913: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:922: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1124: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1347: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1347: 直接使用new操作符 - 建议使用std::make_unique或std::make_shared
  代码:   Page *page = new Page();
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1359: 直接使用delete操作符 - 建议使用RAII模式自动管理内存
  代码:     delete page;
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1370: 直接使用delete操作符 - 建议使用RAII模式自动管理内存
  代码:     delete page;
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1377: 直接使用delete操作符 - 建议使用RAII模式自动管理内存
  代码:     delete page;
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1385: 直接使用delete操作符 - 建议使用RAII模式自动管理内存
  代码:     delete page;
```
...
```
/home/liying/sqlcc/src/storage_engine/buffer_pool.cpp:1475: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:123: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   Page *page = page_ptr.get();
```

**问题 3**:

```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:146: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:171: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   Page *page = storage_engine_->FetchPage(page_id);
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:197: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   Page *page = storage_engine_->FetchPage(page_id);
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:245: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:     Page *page = storage_engine_->FetchPage(page_id);
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:277: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:296: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:349: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:364: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:385: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:416: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:424: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:429: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:          data + sizeof(PageType) + 3 * sizeof(int32_t) + sizeof(uint16_t),
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:432: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:435: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:443: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   char *data = page->GetData();
```
...
```
/home/liying/sqlcc/src/storage_engine/table_storage.cpp:458: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
```
/home/liying/sqlcc/src/unified_executor.cpp:476: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:       BPlusTreeIndex* index = table_storage.GetIndex(table_name, column_name);
```

**问题 2**:

```
/home/liying/sqlcc/src/unified_executor.cpp:519: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:         BPlusTreeIndex* index = table_storage.GetIndex(table_name, column_name);
```
...
```
/home/liying/sqlcc/src/unified_executor.cpp:563: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:       BPlusTreeIndex* index = table_storage.GetIndex(table_name, column_name);
```
...
```
/home/liying/sqlcc/src/unified_executor.cpp:1188: 直接使用delete操作符 - 建议使用RAII模式自动管理内存
...
```
/home/liying/sqlcc/src/unified_executor.cpp:1352: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
  代码:   BPlusTreeIndex* index = table_storage.GetIndex(table_name, column_name);
```
...
```
/home/liying/sqlcc/src/unified_executor.cpp:1849: 裸指针声明 - 建议使用std::unique_ptr或std::shared_ptr
...
#### 📁 /home/liying/sqlcc/tests/components/storage/buffer_pool_test.cpp
