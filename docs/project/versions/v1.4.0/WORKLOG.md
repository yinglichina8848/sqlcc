...
## 2026-02-07 文档 PR 创建（Codex）

**身份**: Codex（AI-IDE）  
**方式**: GitHub PR  
**PR**: https://github.com/yinglichina8848/sqlcc/pull/2  
**范围**: 文档整理与 SDD/TDD/FDD 规范化（不含接口设计/实现）

**补充说明**:
- 纠偏 OpenClaw（高小原）误操作后的范围漂移
- AI 协作规范已对齐（消息协议与覆盖率标准统一）
