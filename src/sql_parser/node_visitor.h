...
public:
  ...
  // DCL语句访问方法
  virtual void visit(CreateRoleStatement &node) = 0;
  virtual void visit(DropRoleStatement &node) = 0;
  virtual void visit(GrantRoleStatement &node) = 0;
  virtual void visit(RevokeRoleStatement &node) = 0;
  ...
  // 窗口函数访问方法
  virtual void visitWindowFunction(WindowFunction &node) = 0;
